...
<body>
	...
	<a href="index.php"><img class="logo4" src="skins/logo2.png"></a>
	...
	<div class="divReg">
		...
		<a href="patient_register.php"><button style="margin-top: 10px;" class="common_btn">Register as Client</button></a>
