...
<body>
    ...
    <h2 class="header">Vet Requested to Cancel</h2>
            ...
            <tbody>
              <?php 
                ...
                while($row = mysqli_fetch_assoc($result))
                {
                  ...
                  echo "<td>Vet Requested To Cancel</td>";
    ...
    <h2 class="header">Client Requested to Cancel</h2>
            ...
            <tbody>
              <?php 
                ...
                while($row = mysqli_fetch_assoc($result))
                {
                  ...
                  echo "<td>Client Requested To Cancel</td>";
            ...
            <tbody>
              <?php 
                ...
                while($row = mysqli_fetch_assoc($result))
                {
                  ...
                  echo "<td>Appointment Done (Confirmed By Vet)</td>";
