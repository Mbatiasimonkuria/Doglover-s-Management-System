...
<body>
	...
	<section id="board">
		...
		<a href="patient_register.php"><button class="add_btn">Add A Client</button></a>
		...
		<table class="blueTable">
            ...
            <tbody>
              ...
              while($row = mysqli_fetch_assoc($result))
              {
                  ...
                  echo "<td style=\"color: red;\"><form method=\"post\"><button type=\"submit\" name=\"Delete\" value=\"".$row['id']."\">Delete</button></form><br>!Warning All Appointments and Files Will Be Deleted Related to This Client</td>";
